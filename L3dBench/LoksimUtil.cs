...
namespace LoksimUtil
{
	...
	public class LoksimHelper
	{
        ...
        public const string cSIM_COMMON_BUCHFAHRPLAN  = "SIM.COMMON.BUCHFAHRPLAN";
        public const string cSIM_COMMON_FAHRPLAN = "SIM.COMMON.FAHRPLAN";
        public const string cSIM_COMMON_ACTPOS = "SIM.COMMON.ACTPOS";
        ...
        //public const string cLOK_INSTRUMENT_PNEUBREMSDRUCK = "LOK.INSTRUMENT.PNEUBREMSDRUCK";
		...
		public const string cLOK_INSTRUMENT_KRAFTPROZENT = "LOK.INSTRUMENT.KRAFTPROZENT";
		public const string cLOK_INSTRUMENT_KRAFTPROZENTKPL = "LOK.INSTRUMENT.KRAFTPROZENTKPL";
		
		//Float
		public const string cSIM_COMMON_SIMTIME = "SIM.COMMON.SIMTIME"; //Zeit die in der Simulation vergangen ist in Sekunden
        public const string cSIM_COMMON_ACTTIME = "SIM.COMMON.ACTTIME"; 
		...
		private static string GetParamRawString( string CodedParamString, string ParamName)
		{
			string Result = "";
